...
const Ramman = () => {
  return (
    <section className="relative py-16 lg:py-36 overflow-hidden flex items-center min-h-[80vh]">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
        ...
        <ScrollDepthLayer
          ...
          shiftX={-15}
          rotateY={2}
          // ✅ removed the spacing prop that was adding extra bottom padding on mobile
        ...
        >
          ...
          >
            <motion.div
              ...
              // ✅ constrain image size on mobile so it doesn't push text far down
              className="relative w-full max-w-[260px] sm:max-w-sm lg:max-w-lg"
            >
              <Image
                src={ramman}
        ...
        >
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-gray-900 tracking-tight">
              Ramman <span className="text-red-600">(festival)</span>
            </h2>

            <h3 className="mt-4 font-body text-gray-700 text-base md:text-lg lg:text-xl leading-relaxed">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-6 px-10 py-4 bg-red-600 text-white font-body font-bold text-lg rounded-full shadow-[0_10px_25px_rgba(220,38,38,0.4)] transition-colors"
            >
              Know More
            </motion.button>
          </motion.div>
